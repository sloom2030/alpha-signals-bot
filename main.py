...
async def send_signal(bot, token_name, price_change_1h, price_change_24h, market_cap, volume_usd, volume_mcap_ratio):
...
async def scan_market(session, bot):
    ...
    for coin in coins:
        try:
            ...
            if price_change_1h is False or price_change_1h is None:
                price_change_1h = 0.0
            else:
                price_change_1h = float(price_change_1h)
            
            if price_change_24h is False or price_change_24h is None:
